...
const PersonalEthicalStatement = () => {
    return (
        <div className="page-content">
            ...
            <div className="page-content">
                ...
                <h5>Conclusion</h5>
                <p>
                    By nature, ethical decisions are not the simplest to make; however, using the models and guidelines above, I can make the informed decision. At the end of the day, if I align myself with God, and strive to follow the Spirit in my actions, while also using the mind I’ve been given to make the best choice, I will become a person of character, who does the right thing for the right reasons. I will make the right ethical decisions, and repair when that is necessary. In this, I will continue to grow for the rest of my life.
                </p>

                <h5>
                    Wilkins, Painter & Patterson, Media Ethics: Chapter 6, Case 6-E, “Cincinnati Enquirer’s Heroin Beat,” pp. 199
                </h5>
                <p>
                    The Enquirer published “Seven days of heroin: This is what an epidemic looks like.” In this, they highlighted work from various journalists and photographers, all capturing real stories and events occurring in the state, that cleared up the muddied perception of what the epidemic really looked like.
                </p>
                <p>
                    In analyzing this case, some have been brought to ask: How might the Enquirer’s reporting influence how the community understands and addresses the heroin and opioid epidemic? Was this an ethical decision?
                </p>
                <p>
                    Personally, I find this ethical. Considering this from the standpoint of loyalty ethics, the Enquirer has a duty not only to its clients (readers,) but also to humanity. As such, they are responsible for reporting on a major issue, and open the public’s eyes to truly let them know what is going on. By doing this, the Enquirer puts the public in a position to act on their own consciences and do their part to help respond to the epidemic. This resounds with the virtues of fairness and advocacy because these people who are in such dire circumstances need advocates. We can treat them with fairness and respect by doing something about it. Without it being reported on, however, this would be less possible.
                </p>
                <p>
                    Further, considering this from the Golden Rule, I would like to be aware of the severity of the issue, and as such, I expect the news to inform me of the truth of the matter.
                </p>
                <p>
                ...
                <ol>
                    ...
                    <li>
                        PRSA Code of Ethics. www. https://www.prsa.org/about/prsa-code-of-ethics.
                    </li>
                    <li>
                        Matthew 7. The Church of Jesus Christ of Latter-day Saints. https://www.churchofjesuschrist.org/study/scriptures/nt/matt/7?lang=eng#title_number1
                    </li>
                    <li>
                        Townsend, Choose the Right. The Church of Jesus Christ of Latter-day Saints. https://www.churchofjesuschrist.org/music/library/hymns/choose-the-right?lang=eng
                    </li>
                    <li>
                        Vaughn, Beginning Ethics, Chapter 4, "Moral Theories," pp 86-88
                    </li>
                    <li>
                        Vaughn, Beginning Ethics, Chapter 11, “Virtue Ethics,” pp. 155-162
                    </li>
                    <li>
                        Wilkins, Painter & Patterson, Media Ethics: Chapter 4 "Loyalty," pp. 99-112
                    </li>
                </ol>
            </div>
        </div>
...
export default PersonalEthicalStatement;